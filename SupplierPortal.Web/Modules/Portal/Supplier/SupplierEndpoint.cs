...
[Route("Services/Portal/Supplier/[action]")]
...
public class SupplierEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.SupplierColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "SupplierList_" +

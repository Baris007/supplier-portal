    ...
    public static class ESM
    {
        public static class Modules
        {
            public static class _Ext
            {
                ...
                {
                    public const string AuditLogPage = "~/esm/Modules/_Ext/AuditLog/AuditLogPage.js";
                }
                public static class NotificationLog
                {
                    public const string NotificationLogPage = "~/esm/Modules/_Ext/NotificationLog/NotificationLogPage.js";
                }
            }
            public static class Membership
            {
                public static class Account
                {
                    ...
                    {
                        public const string ChangePasswordPage = "~/esm/Modules/Membership/Account/ChangePassword/ChangePasswordPage.js";
                    }

                    public static class ForgotPassword
                    {
                        public const string ForgotPasswordPage = "~/esm/Modules/Membership/Account/ForgotPassword/ForgotPasswordPage.js";
                    }
                    ...
                    {
                        public const string ResetPasswordPage = "~/esm/Modules/Membership/Account/ResetPassword/ResetPasswordPage.js";
                    }
    ...
    //
            ...
            public static class Forms
            {
                public static class Membership
                {
                    ...
                    public static class ResetPassword
                    {
                        public static LocalText EmailSubject = "Reset Your SupplierPortal Password";
                    ...
                    public static class SignUp
                    {
                        public static readonly LocalText ActivateEmailSubject = "Activate Your SupplierPortal Account";
                ...
                public static readonly LocalText SiteTitle = "SupplierPortal";
            }
